...
public final class WorkflowService {
    ...
    public WorkflowService(DatabaseManager databaseManager) {
        this(
                new RequestService(Objects.requireNonNull(
    ...
    public WorkflowService(
        ...
        this.auditEventDao = Objects.requireNonNull(
                auditEventDao, "auditEventDao cannot be null");
    ...
    public ServiceRequest transitionStatus(int requestId, String targetStatus)
            throws SQLException {
    ...
    public ServiceRequest transitionStatus(int requestId, String targetStatus, String actorType)
        ...
        if (!canTransition(current.getStatus(), targetStatus)) {
            throw new IllegalStateException(
                    "Invalid request status transition: " + current.getStatus()
                            + " -> " + targetStatus);
        }
    ...
    public ServiceRequest markAssigned(int requestId, String actorType) throws SQLException {
        return transitionStatus(requestId, ASSIGNED, actorType);
    }
